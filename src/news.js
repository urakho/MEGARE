...
const newsData = [
    {
        ...
        content: [
            ...
            "Это гигантский танк с 4000 HP, который атакует огненными метеоритами. Метеориты падают на карту, наносят 150 урона и оставляют огонь на земле.",
            "Когда у босса остаётся 2000 HP, он становится ещё опаснее и начинает выпускать мини-метеориты в стороны. Эти метеориты ломают стены и наносят 75 урона.",
