...
window.mechDiyMeta = {
    name: "Штурмовой мех",
    description: "Мощный боевой мех с двумя плазменными пушками. Работает на энергии — каждый залп требует энергии. При полной батарее мех понемногу восстанавливает HP. При нулевой энергии мех полностью парализован. Требует стратегического управления энергией в бою.",
    rarity: "Редкий"
};
...
window.mechShieldMeta = {
    name: "Щитовой мех",
    description: "Тяжелый боевой мех с усиленной броней и мощными энергетическими пушками. Его массивный щит поглощает урон, а мощные пушки наносят разрушительные удары и даже могут ломать стены. Медленнее и тяжелее, чем другие мехи, но может выдержать огромное количество урона.",
    rarity: "Сверхредкий"
};
