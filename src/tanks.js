...
const tankDescriptions = {
    normal: {
        ...
        description: "Классическая боевая машина с отличной сбалансированностью. Стреляет обычными пулями среднего урона. Идеален для обучения и универсален во всех ситуациях.",
        rarity: "Обычный"
    },
    ice: {
        name: "❄️ Ледяной танк",
    ...
    fire: {
        name: "🔥 Огненный танк",
        description: "Мощный огнемет, сжигающий врагов потоком пламени. Наносит периодический урон и поджигает цели. Имеет повышенный запас прочности (6 HP). Опасен на близкой дистанции.",
        rarity: "Сверхредкий"
    },
    toxic: {
        name: "☠️ Токсичный танк",
    ...
    buratino: {
        name: "🚀 Буратино (ТОС)",
        description: "Тяжелая система залпового огня. Запускает мощный залп из 6 неуправляемых ракет по площадям. Медленный и тяжелый, но наносит колоссальный урон в группировке.",
        rarity: "Эпический"
    },
    musical: {
        name: "🎵 Музыкальный танк",
        description: "Атакует звуковыми волнами, рикошетящими от стен и дезориентирующими врагов. Волна расширяется по мере распространения. Компактный (4 HP), но хитрый тактически.",
        rarity: "Эпический"
    },
    illuminat: {
        name: "👁️ Иллюминат",
    ...
    mirror: {
        name: "🪞 Зеркальный",
        description: "Мастер адаптации. Копирует тип снарядов противника при получении урона и отражает их обратно. Особая способность (E): активирует зеркальный щит, отражающий все входящие атаки. Компактный (4 HP), но опасный защитник.",
        rarity: "Легендарный"
    },
    time: {
        name: "⏳ Временной",
    ...
    machinegun: {
        name: "🔫 Пулемётчик",
        description: "Высокоскоростной боец, стреляющий очередями из 4 пуль. Каждая пуля наносит небольшой урон, но частая огневая мощь компенсирует слабость одного выстрела. Идеален для постоянного давления.",
        rarity: "Редкий"
    },
    buckshot: {
        name: "🟢 Дробовой танк",
        description: "Выстреливает 5 дробин вперёд веером, расходящихся под углом. На близкой дистанции может нанести до 7.5 HP урона (5 × 1.5). На дальней дистанции дробь расходится, и урон снижается. Медленная перезарядка для компенсации мощности.",
        rarity: "Редкий"
    },
    waterjet: {
        name: "💧 Водомётчик",
